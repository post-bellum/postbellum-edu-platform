...
function TableFloatingToolbar({
  ...
  return (
    ...
    >
      ...
      >
        <Toolbar
          className="scrollbar-hide flex w-auto max-w-[80vw] flex-row overflow-x-auto rounded-lg border border-gray-200 bg-white p-1 shadow-lg print:hidden"
          contentEditable={false}
        >
          <ToolbarGroup>
            <ColorDropdownMenu tooltip="Barva pozadí">
              <PaintBucketIcon />
            </ColorDropdownMenu>
            {canMerge && (
              <ToolbarButton
            ...
            <DropdownMenu modal={false}>
              <DropdownMenuTrigger asChild>
                <ToolbarButton tooltip="Ohraničení buněk">
                  <Grid2X2Icon />
                </ToolbarButton>
              </DropdownMenuTrigger>
            ...
            {collapsedInside && (
              <ToolbarGroup>
                <ToolbarButton tooltip="Smazat tabulku" {...buttonProps}>
                  <Trash2Icon />
                </ToolbarButton>
              </ToolbarGroup>
            )}
            ...
            <>
              ...
              <div
                className={cn(
                  ...
                  'right-[-1.5px]',
                  columnResizeVariants({ colIndex: colIndex as 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 })
                )}
              />
              {colIndex === 0 && (
                <div

...
export const ColumnElement = withHOC(
  ...
  function ColumnElement(props: PlateElementProps<TColumnElement>) {
    ...
    const { isDragging, previewRef } = useDraggable({
    ...
    return (
      <div
        className="group/column plate-column relative"
        style={{ width: width ?? '100%' }}
      >
        {/* Drag handle hidden in column blocks */}
        ...
        >
          <div
            className={cn(
              ...
              !readOnly && 'rounded-lg border border-gray-400 border-dashed',
  ...
  return (
    <PlateElement className="mb-2" {...props}>
      <ColumnFloatingToolbar>
        <div className="plate-column-group flex size-full gap-2 rounded">
          {props.children}
        </div>
      </ColumnFloatingToolbar>
    </PlateElement>

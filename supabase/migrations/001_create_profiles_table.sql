...
CREATE TABLE IF NOT EXISTS public.profiles (
  ...
  category TEXT CHECK (category IN ('founder', 'partner', 'parent', 'other')),
...
COMMENT ON COLUMN public.profiles.category IS 'Category for non-teachers only: founder, partner, parent, or other (NULL for teachers)';
